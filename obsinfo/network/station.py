...
class station:
    ...
    def __init__(self,station_dict,station_code,network_code,debug=False):
        ...
        self.station_location= '00' #self.instrument['station_location']  pgerer pour chaque instrument
    ...
    def partial_fill_instrument(self,instrument_file,referring_file=None,debug=False):
        ...
        for instrument in self.instruments:
            ...
            if debug:
                ...
                print(yaml.dump(instrument.das_components))
            ...
            if debug:
                ...
                print(yaml.dump(instrument.das_components))
            self.operator=instruments[reference_code].facility
            if debug:
